            ...
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                            aria-expanded="false">
                            <div class="sb-nav-link-icon"><i class="fa-brands fa-shopify"></i></div> Category
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{ url('vendor/add-category') }}">Add</a></li>
                            <li><a class="dropdown-item" href="{{ url('vendor/view-category') }}">View</a></li>
                        </ul>
                    </li>
